...
const FlightDayFindGate = ({ navigation }: any) => {
  ...
  return (
    <View style={commonStyles.container}>
      ...
      <Text style={commonStyles.title}>{t('findGate', 'title')}</Text>
      ...
      >
        ...
        <View style={commonStyles.listContainer}>
          <Text style={commonStyles.boldText}>{t('findGate', 'heading1')}</Text>
          <Text style={commonStyles.paragraphText}>
            {t('findGate', 'body1')}
          </Text>

          <Text style={commonStyles.boldText}>{t('findGate', 'heading2')}</Text>
          <Text style={commonStyles.paragraphText}>
            {t('findGate', 'body2')}
          </Text>
        </View>
